...
### **Example**
#### `api.games.by.season()`
```{r, fig.width=12, fig.asp=90/212, dpi=300, echo=FALSE, eval=FALSE}
...
- **Arguments**
  ...
  - `all.teams` — `logical(1)` Include all past and current teams? Default `FALSE`
- **Returns**
...
- **Arguments**
  ...
  - `game.types` — list; select one or more c("preseason", "regular.season", "playoffs")
- **Returns**
  - returns - SLAP object
